...
<?php echo $this->Form->create('Accidentetrabajo');?>
	<fieldset>
 		<legend><?php __('Edit Accidentetrabajo'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Accidentetrabajo.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Accidentetrabajo.id'))); ?></li>
