...
<?php echo $this->Form->create('Trabajador');?>
	<fieldset>
 		<legend><?php __('Edit Trabajador'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Trabajador.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Trabajador.id'))); ?></li>
